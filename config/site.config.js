...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'stella@stu.maia-sabis.net',
  ...
  footer:
    'Powered by <a href="https://www.webloadedmovie.com/" target="_blank" rel="noopener noreferrer">Webloaded Movies</a>. Made with ❤ for Movie lovers 🍿.',
  ...
  email: 'https://webloadedmovie.com/contact',
  ...
  links: [
    {
      name: 'WhatsApp',
      link: 'https://whatsapp.com/channel/0029VaCfJJf7dmehSRfoNZ1P',
    },
  ],
